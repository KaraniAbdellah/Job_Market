...
const GetPrediction = () => {
    ...
    const [result, setResult] = useState("> 50K");
    ...
    const handlePredict = (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        console.log(form);
        setResult(Math.random() > 0.5 ? "> 50K" : "<= 50K");
        ...
        <div className="min-h-screen  p-2">
            <div className="max-w-5xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {/* Form */}
                    <form onSubmit={handlePredict} className="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        {renderSelect("employment_type", "Employment Type", employment_type)}
                        {renderSelect("education_level", "Education Level", education_level)}
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-lg p-8 flex flex-col justify-center">
                        <p className="text-sm font-medium text-gray-600 mb-4 text-center">Predicted Salary</p>
                        <p className="text-5xl font-bold text-purple-700 mb-8 text-center">{result}</p>
